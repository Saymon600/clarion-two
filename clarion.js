        ...
        var message = msg.content.split(" ").slice(1).join(" ");
       	...
       	switch(r){
       		...
       		case 3:
       			...
       			break;
       		case 4:
       			bot.createMessage(msg.channel.id, "Y-yeah.",fs.readFileSync(__dirname + "/ask/ehh.png"));
       			break;
       		case 5:
       			bot.createMessage(msg.channel.id, "Nope.");
       			break;
       		case 6:
       			bot.createMessage(msg.channel.id, "", fs.readFileSync(__dirname + "/ask/gowild.png"));
       			break;
       		case 7:
